dcpackage org.firstinspires.ftc.teamcode.Teleop;
...
public class Drive_Control extends OpMode {
    ...
    private DcMotorEx sprocket; // Motor for rotate the Vertical lift
    ...
    public void init() {
        ...
        sprocket = hardwareMap.get(DcMotorEx.class, "rocket");
        ...
        //Sprocket Encoder
        sprocket.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        sprocket.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        sprocket.setDirection(DcMotorSimple.Direction.FORWARD);
    ...
    public void loop() {
        ...
        telemetry.addData("sprocket Level", SprocketLevelPosition[SprocketLevel]);
        telemetry.addData("sprocket Position", sprocket.getCurrentPosition());
        telemetry.update();
    }
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Method to control the sprocket motor mechanism
    public void sprocketBoom() {
        // Check if the dpad_up button on gamepad2 is pressed
        if (gamepad2.dpad_up ) {

            sprocket.setTargetPosition(970);
            sprocket.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        }
        else if(gamepad2.dpad_left){
            sprocket.setTargetPosition(760);
            sprocket.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        }
        else if(gamepad2.dpad_right){
            sprocket.setTargetPosition(200);
            sprocket.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        }
